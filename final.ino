...
void loop() {
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0)) {
   ...
   s3 = !digitalRead(slot3);
    ...
    if (carEntry == 1) {               // If high, then count and send data
      ...
      if (Firebase.RTDB.setInt(&fbdo, "/ParkingStatus/countYes", countYes)) {
    ...
    if (s1 == 1 && s1_occupied == false) {                     
          ...
          if (Firebase.RTDB.setString(&fbdo, "/ParkingStatus/slot1", msg1)) {
    ...
    if(s1 == 0 && s1_occupied == true) {
       Serial.println("Available 1");
        ...
        if (Firebase.RTDB.setString(&fbdo, "/ParkingStatus/slot1", msg2)) {
        Serial.print("parking slot successfully saved to: ");
        Serial.println(fbdo.dataPath());
        } else {
          Serial.println("FAILED: " + fbdo.errorReason());
  ...
  if (s2 == 1 && s2_occupied == false) {                     
        ...
        if (Firebase.RTDB.setString(&fbdo, "/ParkingStatus/slot2", msg1)) {
        Serial.print("parking slot successfully saved to: ");
        Serial.println(fbdo.dataPath());
        } else {
          Serial.println("FAILED: " + fbdo.errorReason());
  ...
  if(s2 == 0 && s2_occupied == true) {
       Serial.println("Available 2");
        ...
        if (Firebase.RTDB.setString(&fbdo, "/ParkingStatus/slot2", msg2)) {
        Serial.print("parking slot successfully saved to: ");
        Serial.println(fbdo.dataPath());
        } else {
          Serial.println("FAILED: " + fbdo.errorReason());
  ...
  if (s3 == 1 && s3_occupied == false) {                     
        ...
        if (Firebase.RTDB.setString(&fbdo, "/ParkingStatus/slot3", msg1)) {
        Serial.print("parking slot successfully saved to: ");
        Serial.println(fbdo.dataPath());
        } else {
          Serial.println("FAILED: " + fbdo.errorReason());
  ...
  if(s3 == 0 && s3_occupied == true) {
       Serial.println("Available 3");
        ...
        if (Firebase.RTDB.setString(&fbdo, "/ParkingStatus/slot3", msg2)) {
        Serial.print("parking slot successfully saved to: ");
        Serial.println(fbdo.dataPath());
        } else {
          Serial.println("FAILED: " + fbdo.errorReason());
    ...
    if (Firebase.RTDB.setString(&fbdo, "/ParkingStatus/Available", fireAvailable)) {
